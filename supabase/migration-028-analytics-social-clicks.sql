-- ============================================================
-- YUMYUMPO — Migration 028 · Social-click metrics in analytics
-- The restaurant page's floating contact bubbles (WhatsApp,
-- Messenger, Instagram, Website) now log clicks to
-- analytics_events. Add Instagram + Messenger click counts to the
-- per-restaurant analytics bundle (WhatsApp + Website already there).
-- ============================================================
